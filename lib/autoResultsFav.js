...
function getCreatorURL() {
	...
	//var favoriteService = orion.serviceregistry.ServiceRegistry.getService("orion.core.favorite");
	//favoriteService.addFavoriteUrl("http://9.27.153.147:8080/OSLC4JAutomation/services/autoResults/7");
	return "http://9.27.153.147:8080/OSLC4JAutomation/services/autoResults/7";
...
window.onload = function() {
	...
	var serviceImpl = {
		run : function(text, fullText, selection, fileName) {
		    ...
		    if (launchUrl) {
				return {uriTemplate: launchUrl, width: "600px", height: "15px"};
			}
		}
	};
